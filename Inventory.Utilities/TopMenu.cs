...
namespace Inventory.Utilities
{
    public static class TopMenu
    {
...

        {
            ...
            public const string ControllerName = "MeasureUnit";
            public const string ActionName = "Index";
        }
        public static class NumberSequence

        {
            public const string PageName = "NumberSequence";
            public const string RoleName = "NumberSequence";
            public const string Path = "/NumberSequence/Index";
            public const string ControllerName = "NumberSequence";
            public const string ActionName = "Index";
        }
...

        {
            ...
            public const string ControllerName = "PurchaseOrderLine";
            public const string ActionName = "Index";
        }
        ...
        public static class RecivedNote

        {
            public const string PageName = "RecivedNote";
            public const string RoleName = "RecivedNote";
            public const string Path = "/RecivedNote/Index";
            public const string ControllerName = "RecivedNote";
            public const string ActionName = "Index";
        }
...

        {
            ...
            public const string ControllerName = "SalesOrderLine";
            public const string ActionName = "Index";
        }
        ...
        {
            public const string PageName = "Shippment";
            public const string RoleName = "Shippment";
            public const string Path = "/Shippment/Index";
            public const string ControllerName = "Shippment";
            public const string ActionName = "Index";
        }
        public static class ShippmentType

        {
            public const string PageName = "ShippmentType";
            public const string RoleName = "ShippmentType";
            public const string Path = "/ShippmentType/Index";
            public const string ControllerName = "ShippmentType";
            public const string ActionName = "Index";
        }
