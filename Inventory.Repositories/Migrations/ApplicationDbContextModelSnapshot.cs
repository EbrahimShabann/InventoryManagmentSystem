...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory.Models.PaymentReceive", b =>
                {
                    ...
                    b.ToTable("PaymentReceives", (string)null);
                });
            ...
            modelBuilder.Entity("Inventory.Models.Product", b =>
                {
                    ...
                    b.Property<string>("Prdouctimage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Inventory.Models.RecivedNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("VendorInoviceNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("RecivedNotes", (string)null);
                });
            ...
            modelBuilder.Entity("Inventory.Models.Shippment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsFullShippment")
                        .HasColumnType("bit");

                    b.Property<int>("SalesOrderId")
                        .HasColumnType("int");

                    b.Property<DateTimeOffset>("ShippmentDate")
                        .HasColumnType("datetimeoffset");

                    b.Property<string>("ShippmentName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ShippmentTypeId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Shippments", (string)null);
                });

            modelBuilder.Entity("Inventory.Models.ShippmentType", b =>
                {
                    b.Property<int>("ShippmentTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ShippmentTypeId"));
                    ...
                    b.HasKey("ShippmentTypeId");

                    b.ToTable("ShippmentTypes", (string)null);
                });
